      ...
      <div className="min-h-screen flex flex-col bg-background">
        ...
        <main className="flex-1 flex items-center justify-center px-4">
          <div className="text-center">
            ...
            <Link
              href="/login"
              className="px-6 py-2 bg-accent text-accent-foreground font-bold rounded-lg hover:opacity-90 transition"
            >
              Go to Login
            </Link>
          </div>
  ...
  const paymentMethods = [
    {
      ...
      description: "Pay via WhatsApp - Quick and secure",
      icon: MessageCircle,
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8">
        ...
        <button
          onClick={() => router.back()}
          className="flex items-center gap-2 text-accent hover:opacity-80 transition mb-6 font-medium"
        >
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div
                        className={`w-6 h-6 rounded-full border-2 flex items-center justify-center flex-shrink-0 ${
                          selectedMethod === method.id ? "bg-accent border-accent" : "border-border"
                        }`}
                      >
            ...
            {selectedMethod === "whatsapp" && (
              <div className="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                <p className="text-sm text-green-800">
                  <strong>WhatsApp Payment:</strong> Click "Pay Now" and you'll be redirected to WhatsApp to complete
                  your payment with our support team.
                </p>
              </div>
            )}
          </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-card rounded-lg border border-border p-6 sticky top-20">
              ...
              <button
                ...
                className="w-full px-4 py-3 bg-accent text-accent-foreground font-bold rounded-lg hover:opacity-90 transition disabled:opacity-50 disabled:cursor-not-allowed"
              >
