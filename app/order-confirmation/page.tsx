        ...
        <div className="text-center">
          ...
          <div className="bg-card rounded-lg border border-border p-8 mb-8">
            ...
            <div className="space-y-3">
              <Link
                href="/products"
                className="block w-full px-6 py-3 bg-accent text-accent-foreground font-bold rounded-lg hover:opacity-90 transition text-center"
              >
                Continue Shopping
              </Link>
              <Link
                href="/profile"
                className="block w-full px-6 py-3 border border-accent text-accent font-bold rounded-lg hover:bg-accent/10 transition text-center"
              >
                View My Orders
              </Link>
            </div>
