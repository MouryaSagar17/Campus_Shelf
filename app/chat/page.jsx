              ...
              {conversations.length === 0 ? (
                ...
                conversations.map((conv) => (
                  <button
                    ...
                    aria-label={`Open conversation with ${conv.sellerName}`}
          ...
          {currentConversation ? (
            <div className="lg:col-span-3 bg-card rounded-lg border border-border flex flex-col">
              ...
              <div className="p-4 border-b border-border flex items-center justify-between">
                ...
                <button onClick={handleDeleteConversation} className="p-2 hover:bg-red-50 text-red-600 rounded transition" title="Delete conversation">
              ...
              <form onSubmit={handleSendMessage} className="p-4 border-t border-border">
                <div className="flex gap-2">
                  ...
                  />
                  <button type="submit" disabled={!newMessage.trim()} className="px-4 py-2 bg-accent text-accent-foreground rounded-lg hover:opacity-90 transition disabled:opacity-50 disabled:cursor-not-allowed">
