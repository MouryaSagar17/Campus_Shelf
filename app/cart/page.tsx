        ...
        {cart.length === 0 ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="px-3 py-1 border border-border rounded-lg hover:bg-muted transition"
                        >
                          -
                        </button>
                        <input
              ...
              <button
                onClick={clearCart}
                className="mt-4 px-4 py-2 text-red-500 border border-red-500 rounded-lg hover:bg-red-50 transition font-medium"
              >
                Clear Cart
              </button>
            </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-card rounded-lg border border-border p-6 sticky top-20">
                ...
                <Link
                  href="/products"
                  className="block text-center px-4 py-3 border border-accent text-accent font-bold rounded-lg hover:bg-accent/10 transition"
                >
                  Continue Shopping
                </Link>
              </div>
